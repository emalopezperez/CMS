...
export default function FormCreateCollaborator() {
  return (
    <form className='p-5 md:p-10 bg-gray-900 h-full'>
      <div className="divide-y divide-white/5">
        <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
          <div>
            <h2 className="text-2xl font-semibold leading-7 text-white">Agregar colaborador</h2>
          </div>
